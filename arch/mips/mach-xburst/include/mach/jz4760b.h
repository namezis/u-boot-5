...
#define DDRC_PMEMPS0	(DDRC_BASE + 0x0050)
#define DDRC_PMEMPS1	(DDRC_BASE + 0x0054)
#define DDRC_PMEMPS2	(DDRC_BASE + 0x0058)
#define DDRC_PMEMPS3	(DDRC_BASE + 0x0005c)
...
#define REG_BCH_ERR(n)  (REG32(BCH_ERR0 + 4 * (n)))
