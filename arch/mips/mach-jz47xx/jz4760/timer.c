...
int timer_init(void)
{
	...
	reset_timer();
	writel(OSTCSR_CNT_MD | OSTCSR_EXT_EN | OSTCSR_PRESCALE_4,
	       regs + TCU_OSTCSR);
...
void reset_timer(void)
{
	...
	writel(0, regs + TCU_OSTCNT);
}

static u64 get_timer64(void)
{
	void __iomem *regs = (void __iomem *)TCU_BASE;
	return (u64)readl(regs + TCU_OSTCNT);
}
...
void jz4760_tcu_wdt_start(void)
{
